      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/tours/i/".concat(tourId),
              data: value
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:8000/guide/".concat(name)
            });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              console.log(coordinates); // coordinates1.forEach(el => {
